...
public interface UsersMapper {
	...
	Users getUsers(@Param("user_sequence_id")String user_sequence_id);
	
	@Insert("INSERT INTO users(user_id, user_pwd, user_name, user_year, user_month, user_day, user_email, user_mobile, user_regdate) "
	...
	int updateUsers(@Param("user_pwd")String user_pwd, 
			@Param("user_name")String user_name, @Param("user_year")int user_year, 
			@Param("user_month")int user_month, @Param("user_day")int user_day, 
			@Param("user_email") String user_email, @Param("user_mobile") String user_mobile, @Param("user_sequence_id")String user_sequence_id);
	
	@Delete("DELETE FROM users WHERE user_sequence_id=#{user_sequence_id}")
	int deleteUsers(@Param("user_sequence_id")String user_sequence_id);
