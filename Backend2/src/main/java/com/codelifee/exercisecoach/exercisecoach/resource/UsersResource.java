...
public class UsersResource {
	...
	public Users getUsers(@PathVariable("user_sequence_id")String user_sequence_id) {
	...
	@PostMapping("/{user_sequence_id}")
	public void updateUsers(@PathVariable("user_sequence_id")String user_sequence_id, @RequestParam("user_pwd")String user_pwd, 
			@RequestParam("user_name")String user_name, @RequestParam("user_year")int user_year, 
			@RequestParam("user_month")int user_month, @Param("user_day")int user_day, 
			@RequestParam("user_email") String user_email, @RequestParam("user_mobile") String user_mobile) {
		usersMapper.updateUsers(user_pwd, user_name, user_year, user_month, user_day, user_email, user_mobile, user_sequence_id);
	}
	
	@DeleteMapping("/{user_sequence_id}")
	public void deleteUsers(@PathVariable("user_sequence_id")String user_sequence_id) {
