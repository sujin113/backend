...
public interface CommentsMapper {
	...
	@Insert("INSERT INTO comments(contents,comment_regdate,user_sequence_id,exercise_sequence_id) VALUES(#{contents},addtime(now(),'0 9:0:0'),#{user_sequence_id},#{exercise_sequence_id})")
	...
	@Update("UPDATE comments SET contents=#{contents},comment_regdate=addtime(now(),'0 9:0:0') where comment_sequence_id=#{comment_sequence_id}")
